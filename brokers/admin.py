...
class BrokerAdmin(admin.ModelAdmin):
    list_display = ('name', 'min_deposit', 'withdrawal_time', 'deposit_limit', 'islamic_account')
    list_filter = ('deposit_limit', 'islamic_account', 'headquarters')
    search_fields = ('name', 'seo_title')
    prepopulated_fields = {'slug': ('name',)}
    inlines = [BrokerFAQInline]
    filter_horizontal = ('regulators', 'financial_assets', 'trading_platforms', 'headquarters')
