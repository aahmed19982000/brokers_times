"""
Django settings for brokers_times project.
...
ROOT_URLCONF = 'brokers_times.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'pages.context_processors.site_settings_context',
            ],
        },
    },
]

WSGI_APPLICATION = 'brokers_times.wsgi.application'
